...
###############
## ht_helper_utilities
taskfile_line_template = "stdbuf -o0 -e0 python /global/home/users/nthomas/git/slip-upstream/run_regression_main.py --kwargs_json='{kwargs_json}' --output_dir={output_dir} --job_id=$HT_TASK_ID"
